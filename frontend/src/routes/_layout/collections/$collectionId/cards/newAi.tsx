...
export const Route = createFileRoute('/_layout/collections/$collectionId/cards/newAi')({
  component: NewCardAi,
})
  ...
  return (
    <VStack h="calc(100dvh - 10rem)" width="100%" gap={4}>
      ...
      <HStack width="100%" justify="center" pt={4}>
        <Button colorPalette="red" onClick={handleRetry} size="lg">
          <FaDeleteLeft /> {t('components.editorFooter.rejectAiSuggestion')}
        </Button>
        <Button colorPalette="green" onClick={handleClose} size="lg">
